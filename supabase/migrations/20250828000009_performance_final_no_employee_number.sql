-- Performance Optimization Migration (PRODUCTION READY)
...
CREATE INDEX IF NOT EXISTS idx_workers_first_name 
ON public.workers(first_name);

CREATE INDEX IF NOT EXISTS idx_workers_last_name 
ON public.workers(last_name);
...
BEGIN
    ...
    RAISE NOTICE '✅ Fixed all type mismatches:';
    RAISE NOTICE '   - JSONB psychosocial_factors';
    RAISE NOTICE '   - UUID user_id types';
    RAISE NOTICE '   - Removed employee_number references';
