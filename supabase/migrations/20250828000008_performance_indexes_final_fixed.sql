-- Performance Optimization Migration (FULLY FIXED VERSION)
...
-- 
-- FIXES:
-- - Handles psychosocial_factors as JSONB type
-- - Removes references to non-existent is_active column
-- - Removes references to non-existent is_primary column
...
BEGIN
    ...
    IF p_user_id IS NOT NULL THEN
        ...
        ELSE
            -- Get user's assigned employers (simplified without is_active check)
...
BEGIN
    ...
    IF v_user_role_id IN (1, 2, 3, 4) THEN
        ...
        END IF;
    ELSE
        -- Get user's assigned employers (simplified)
...
BEGIN
    RAISE NOTICE '================================================';
    RAISE NOTICE 'Performance optimization complete! (FINAL FIX)';
    RAISE NOTICE '================================================';
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'This migration works with the simplified';
    RAISE NOTICE 'user_employers table structure.';
    RAISE NOTICE '================================================';
END $$;