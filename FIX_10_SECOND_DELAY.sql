-- =====================================================
-- FIX FOR 10-SECOND DASHBOARD DELAY
-- =====================================================

-- The problem: While individual queries are fast (1-4ms), 
-- the dashboard still takes 10 seconds. This is likely due to:
-- 1. Multiple round trips to the database
-- 2. React re-rendering issues
-- 3. Network latency amplification

-- =====================================================
-- SOLUTION: Create a single combined function
-- =====================================================
-- This returns both incidents AND count in one query
...
-- =====================================================
-- This should return both data and count in a single query
