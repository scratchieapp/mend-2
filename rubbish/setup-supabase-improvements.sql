...
-- Step 1: Add medical_professional_id column to incidents table
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE constraint_name = 'fk_medical_professional'
    ) THEN
        ALTER TABLE public.incidents
...
-- Step 2: Create RPC function to search medical professionals by name
...
-- Step 3: Create RPC function to get all medical professionals
...
-- Step 4: Create comprehensive incidents list view function with pagination
...
-- Step 5: Create a function to get total incident count for pagination
...
-- Step 6: Insert sample medical professionals (if none exist)
INSERT INTO public.medical_professionals (first_name, last_name, specialty, phone_number, email, registration_number, address, suburb, state, post_code)
SELECT * FROM (VALUES
  ('Dr. Sarah', 'Johnson', 'Emergency Medicine', '02 9555 1234', 'sarah.johnson@medical.com', 'MED123456', '123 Medical Centre', 'Sydney', 'NSW', '2000'),
  ('Dr. Michael', 'Chen', 'Orthopedic Surgery', '02 9555 2345', 'michael.chen@medical.com', 'MED234567', '456 Health Plaza', 'North Sydney', 'NSW', '2060'),
  ('Dr. Emily', 'Williams', 'General Practice', '02 9555 3456', 'emily.williams@medical.com', 'MED345678', '789 Care Clinic', 'Chatswood', 'NSW', '2067'),
  ('Dr. James', 'Brown', 'Occupational Medicine', '02 9555 4567', 'james.brown@medical.com', 'MED456789', '321 Wellness Center', 'Parramatta', 'NSW', '2150'),
  ('Dr. Lisa', 'Anderson', 'Sports Medicine', '02 9555 5678', 'lisa.anderson@medical.com', 'MED567890', '654 Recovery Institute', 'Bondi', 'NSW', '2026')
) AS t(first_name, last_name, specialty, phone_number, email, registration_number, address, suburb, state, post_code)
WHERE NOT EXISTS (SELECT 1 FROM public.medical_professionals LIMIT 1);
...
-- Check if medical_professional_id column was added
SELECT column_name, data_type 
FROM information_schema.columns 
WHERE table_name = 'incidents' 
AND column_name = 'medical_professional_id';

-- Check if RPC functions were created
SELECT routine_name 
FROM information_schema.routines 
WHERE routine_schema = 'public' 
AND routine_name IN ('search_medical_professionals', 'get_all_medical_professionals', 'get_incidents_with_details', 'get_incidents_count');

-- Check medical professionals data
SELECT doctor_id, first_name || ' ' || last_name as full_name, specialty 
FROM public.medical_professionals 
LIMIT 5;