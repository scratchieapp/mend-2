...
export const MissingHoursCard = ({ selectedMonth, selectedEmployerId }: Props) => {
  ...
  return (
    <Card className={`relative overflow-hidden border-l-4 ${borderColor} hover:shadow-lg transition-all duration-200 cursor-pointer flex flex-col h-full`} onClick={handleClick}>
      ...
      <CardContent className="pt-0 flex flex-col flex-1">
        ...
        <div className="h-[72px] flex flex-col justify-center">
          <div className="text-3xl font-bold text-foreground leading-none">{missingSites?.count || 0}</div>
